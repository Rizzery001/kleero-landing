        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <div className="mt-7 flex flex-col sm:flex-row gap-3">
              ...
              <a href={telegramLink('landing_hero')} className={FEATURES.SHOW_WHATSAPP ? "inline-flex items-center justify-center gap-2.5 rounded-full px-5 py-3 bg-cream-50/10 hover:bg-cream-50/15 border border-cream-50/20 text-cream-50 font-medium tracking-tight text-[15px] transition-all duration-200 hover:-translate-y-0.5 backdrop-blur-sm" : "btn-primary"} target="_blank" rel="noopener noreferrer">

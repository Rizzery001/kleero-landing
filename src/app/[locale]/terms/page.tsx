...
export default function TermsPage({ params: { locale } }: Props) {
  ...
  const filePath = path.join(process.cwd(), 'src/content/legal', `terms-${lang}.md`);
  ...
  return (
    <main className="min-h-screen bg-cream-50 py-20">
      <div className="container-x max-w-3xl mx-auto">
        <article className="prose prose-stone prose-headings:font-display prose-headings:text-forest-700 prose-a:text-terracotta-500 max-w-none">
...
// Reuse same markdown renderer as in privacy page
